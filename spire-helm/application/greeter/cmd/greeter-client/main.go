...
func main() {
	...
	log.Println("going to call api")
	source, err := workloadapi.NewX509Source(ctx)
	log.Println("outside of the api")
	if err != nil {
		log.Println("error 1")
		log.Fatal(err)
	}
	...
	log.Println("id = aws/greeter-server")

	serverID := spiffeid.RequireFromString("spiffe://aws.com/ns/greeter-server/sa/default")
